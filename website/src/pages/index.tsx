        ...
        <div className={styles.frameText}>
          ...
          <div className="row">
            <div className="col col--4 col--offset-2">
              <p>
                <strong>
                  Connect to MU/TH/UR without the umbilical&nbsp;cord.
                </strong>{" "}
                <br />
              ...
              <p>
                ...
                shipwide wireless connectivity. Review priority directives,
                access system diagnostics, or consult MU/TH/UR from anywhere on
                the vessel - no fixed console, no hardline dependency. Advanced
            ...
            <div className="col col--4">
              <p>
                ...
                precise, unambiguous input in low-light, high-stress
                environments.
              </p>
              <p>
        ...
        <div className={styles.frameText}>
          ...
          <div className="row">
            <div className="col col--4 col--offset-2">
              ...
              <p>
                The PX-88 delivers all the power and specialized features
                expected from a professional system - but built around a
                dedicated, uncompromising user experience. Is it a cyberdeck or
                a writerdeck? It's whatever you need it to be. The reliable
                Raspberry Pi 4 B core handles demanding web-based editors and
                complex tasks with robust performance. The compact size belies
                the strength within.
              </p>
            </div>
            <div className="col col--4">
