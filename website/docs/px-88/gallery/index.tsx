  ...
  return (
    <>
      ...
      <p>
        ...
        built a Typeframe with a ton of enhancements including a Pi 5, speaker,
        alternate power switch, and modified case to fit a different keyboard.
        He even made a battery status system tray icon! Thanks to Paul for also
        helping to uncover some issues with the build and documentation.
        <br />
        <a
