...
This guide covers the complete setup process for a **Raspberry Pi 4B** running **Raspberry Pi OS Trixie** with Waveshare 7.9" DSI display and Power Management HAT.
...
| **Soft Shutdown**  | Long Press (> 4 seconds but < 8 seconds) | Pi executes a graceful software shutdown, and the HAT cuts power. |
